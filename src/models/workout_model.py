...
class Workout(db.Model):
  ...
  workout_plan_links = db.relationship('WorkoutPlanLink', back_populates='workout', order_by='WorkoutPlanLink.sequence')
  workout_stats = db.relationship('WorkoutStat', back_populates='workout', order_by='WorkoutStat.date')
